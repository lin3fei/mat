 ...
 * @since  [产品/模块版本]
 */
public class OautherPropertyUtil
{
    ...
    static
    {
        ...
        {
            configFile = new File(
                    OautherPropertyUtil.class.getResource("/config/oauther.properties")
                            .getPath());
            load();
        }
        catch (Exception e)
    ...
    {
        System.out.println(getValue("get_access_token_uri"));
        
//        String[] ipArray = OautherPropertyUtil.getValue4Array("serverIP");
