...
//        AlipayCore.logResult(sWord);
    ...
    */
     ...
     * @see [类、类#方法、类#成员]
     */
    public static Map<String, String> decrypt(Map<String, String> paramMap,
            String input_charset)
    {
        ...
        try
        {
            ...
            for (Iterator<String> iter = paramMap.keySet().iterator(); iter.hasNext();)
            {
                ...
                returnMap.put(RSA.decrypt(name, private_key, input_charset), RSA.decrypt(value, private_key, input_charset));
            }
        }
        catch (Exception e)
        {
